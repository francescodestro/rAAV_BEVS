function [t,x] = infection_RK3_lagr_efficient
    ...
    if err_est <= rtol
        ...
        if sum_h >= Dtau
            ...
            % max age: accumulate cells
                i1=n_bins;
                i2=(n_bins-age_end_inf/Dtau+1):n_bins;  % i2=2:n_bins;
                i2=i2+startCo-1;
                x(i2+n_bins*(i1-1))=x(i2+n_bins*(i1-1))+x(i2-1+n_bins*(i1-2));
    
                i1=(n_bins-age_end_inf/Dtau+1):n_bins-1; % i1=2:n_bins-1;
                i2=n_bins;
                i2=i2+startCo-1;
                x(i2+n_bins*(i1-1))=x(i2+n_bins*(i1-1))+x(i2-1+n_bins*(i1-2));
...
%         dCodt=zeros(1,length(Co));
        ...
        dCodt(1+n_bins*((2:n_bins_inf)-1))=dCodt(1+n_bins*((2:n_bins_inf)-1))+...
