...
for i=1:n_steps
    ...
    k1=inf_model(t_inf,x);
    k2=inf_model(t_inf+Dt/2,x+k1*Dt/2);
    k3=inf_model(t_inf+Dt/2,x+k2*Dt/2);
    k4=inf_model(t_inf+Dt,x+k3*Dt);
