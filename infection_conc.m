...
% intracellular species concentration expressed per unit volume:
% binded virus in infected cells starts now at 1, as feasible
% not all the intracellular balances have been checked for consistency
% for proper results UOM has to be checked inside
...
k_assembly=1e5; % fast step assumption
...
%     k_degrBV=0; %1/h
    ...
    dxdt(7)=k_bind*x(2)*C-k_endos_in*x(7);
    dxdt(8)=k_bind*x(3)*C-k_endos_in*x(8); % BV rep/cap on surface
...
%     dxdt(7:8)=dxdt(7:8)*C;
    ...
    % itr/goi
    dxdt(13)=k_nucl*x(11)+k_repl*x(13)*f_BVrepl-k_BVrel*C0*f_BVrel*x(13)/...
        (x(13)+x(14)+1e-12);
    % rep/cap
    dxdt(14)=k_nucl*x(12)+k_repl*x(14)*f_BVrepl-k_BVrel*C0*f_BVrel*x(14)/...
        (x(13)+x(14)+1e-12);
    ...
    % goi 
    dxdt(16)=k_goi_repl*x(13)*x(15)*n_VL/C0-k_pack*x(16)*x(18)/C0;

    % cap
    dxdt(17)=k_vp_syn*x(14)*n_VL-k_degr_vp*x(17)-60*k_assembly*x(17);

    % CapRepComplex
    dxdt(18)=k_rep_bind*x(15)*x(19)/C0-k_pack*x(16)*x(18)/C0;
    
    % AAVempty_intra
    dxdt(19)=k_assembly*x(17)-k_AAVrel*x(19)-k_rep_bind*x(15)*x(19)/C0;
    
    % AAVfilled_intra
    dxdt(20)=k_pack*x(16)*x(18)/C0-k_AAVrel*x(20);

    % AAVempty_EC
    dxdt(21)=k_AAVrel*x(19);

    % AAVfilled_EC
    dxdt(22)=k_AAVrel*x(20);
